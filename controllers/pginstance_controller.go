...
//+kubebuilder:rbac:groups=postgres.postgres.brose.bike,resources=pginstances,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=postgres.postgres.brose.bike,resources=pginstances/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=postgres.postgres.brose.bike,resources=pginstances/finalizers,verbs=update
